...
experiment_name = "gd_lrst_lambda0.1_l2lambda0.01_both_1e5epochs_unreg_invex_l2_A_uncaled"
...
with torch.no_grad():
    ...
    plt.title(r'(Linear) Least Squares Regression (lr$\approx0.005$, $\lambda_1=0.1$, $\lambda_2=0.01$ NO SCALING)')
    ...
    # plt.title(r'(Linear) Least Squares Regression (lr$\approx0.005$, $\lambda_1=0.01$, $\lambda_2=0.0001$)')

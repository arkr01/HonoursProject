...
experiment_name = f"sgd_lr{lr}_compare"
...
with torch.no_grad():
    ...
    plt.suptitle(plot_title + 'Scalar vs Standard Invex Regularisation')

    plt.subplot(2 if model != 'diffusion_model' else 1, 2, 1)
    ...
    plt.subplot(2 if model != 'diffusion_model' else 1, 2, 2)
    ...
    plt.legend(['Unregularised', r'Invex $\lambda=0.1$', r'Invex Scalar $\lambda=0.1$', r'Invex $\lambda=0.01$',
                ...
                r'Invex $\lambda=0.0001$', r'Invex Scalar $\lambda=0.0001$'], bbox_to_anchor=(1.7, 1))
    if model == "diffusion_model":
        plt.tight_layout()
        plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Train_Test/Tuning/{experiment_name}_invex.pdf', format='pdf',
                    dpi=1200)
    else:
        plt.subplot(2, 2, 3)
    ...
    plt.suptitle(plot_title + r'$\ell_2$ Regularisation')
    ...
    plt.legend(['Unregularised', r'$\ell_2$ $\lambda=0.1$', r'$\ell_2$ $\lambda=0.01$', r'$\ell_2$ $\lambda=0.001$',
                r'$\ell_2$ $\lambda=0.0001$'], bbox_to_anchor=(1.5, 1))
    if model == "diffusion_model":
        plt.tight_layout()
        plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Train_Test/Tuning/{experiment_name}_l2.pdf', format='pdf',
                    dpi=1200)
    else:
        plt.subplot(2, 2, 3)
        plt.plot(epochs_to_plot, unreg_train_acc, 'k', ls=':')
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Gradient Norm/{experiment_name}_invex_total.pdf', format='pdf',
                dpi=1200)
    ...
    plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Gradient Norm/{experiment_name}_l2.pdf', format='pdf', dpi=1200)
    ...
    plt.title(rf'{plot_title}Standard vs Scalar Invex Regularisation')
    plt.tight_layout()
    plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Gradient Norm/{experiment_name}_invex_theta.pdf', format='pdf',
                dpi=1200)
    ...
    plt.title(rf'{plot_title}Standard vs Scalar Invex Regularisation')
    plt.tight_layout()
    plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Gradient Norm/{experiment_name}_invex_p.pdf', format='pdf', dpi=1200)

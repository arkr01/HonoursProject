...
model_title = "DDPM" if model == "diffusion_model" else "ResNet-18 Classification"
...
with torch.no_grad():
    ...
    plt.subplot(1, 2, 1)
    plt.plot(epochs_to_plot, unreg_train_loss, 'k')
    plt.plot(epochs_to_plot, invex_train_loss, 'r', ls=(0, (5, 1)))  # densely dashed
    plt.plot(epochs_to_plot, invex_ones_train_loss, 'gx', ls=(0, (1, 1)))  # x + dotted
    ...
    plt.subplot(1, 2, 2)
    plt.plot(epochs_to_plot, unreg_test_loss, 'k')
    plt.plot(epochs_to_plot, invex_test_loss, 'r', ls=(0, (5, 1)))  # densely dashed
    plt.plot(epochs_to_plot, invex_ones_test_loss, 'gx', ls=(0, (1, 1)))  # x + dotted
    ...
    plt.legend(['Unregularised', 'Invex', 'Invex Scalar', r'$\ell_2$', 'Data Augmentation', 'Dropout',
                'Batch Normalisation'], bbox_to_anchor=(1.65, 1))
    plt.xlabel('Epochs')
    plt.ylabel('Avg Test Loss')

    plt.tight_layout()
    # plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Test/Loss/{experiment_name}.jpg')
    plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Train_Test/Loss/{experiment_name}.pdf', format='pdf', dpi=1200)
    ...
    if model != "diffusion_model":
        ...
        plt.subplot(1, 2, 1)
        plt.plot(epochs_to_plot, unreg_train_acc, 'k')
        plt.plot(epochs_to_plot, invex_train_acc, 'r', ls=(0, (5, 1)))  # densely dashed
        plt.plot(epochs_to_plot, invex_ones_train_acc, 'gx', ls=(0, (1, 1)))  # x + dotted
        ...
        plt.subplot(1, 2, 2)
        plt.plot(epochs_to_plot, unreg_test_acc, 'k')
        plt.plot(epochs_to_plot, invex_test_acc, 'r', ls=(0, (5, 1)))  # densely dashed
        plt.plot(epochs_to_plot, invex_ones_test_acc, 'gx', ls=(0, (1, 1)))  # x + dotted
        ...
        plt.legend(['Unregularised', 'Invex', 'Invex Scalar', r'$\ell_2$', 'Data Augmentation', 'Dropout',
                    'Batch Normalisation'], bbox_to_anchor=(1.04, 1))
        plt.xlabel('Epochs')
        plt.ylabel('Avg Test Accuracy')

        plt.tight_layout()
        # plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Test/Accuracy/{experiment_name}.jpg')
        plt.savefig(PLOTS_RESULTS_FOLDER +
                    f'{model}/Train_Test/Accuracy/{experiment_name}.pdf', format='pdf', dpi=1200)

    # Plot infinity gradient norm convergence for different models
    plt.figure(figsize=(9, 4))
    plt.plot(epochs_to_plot, unreg_grad_norm_total, 'k')
    plt.plot(epochs_to_plot, invex_grad_norm_total, 'r', ls=(0, (5, 1)))  # densely dashed
    plt.plot(epochs_to_plot, invex_ones_grad_norm_total, 'gx', ls=(0, (1, 1)))  # x + dotted
    ...
    plt.savefig(PLOTS_RESULTS_FOLDER + f'{model}/Gradient Norm/{experiment_name}_total.pdf', format='pdf',
                dpi=1200)
    ...
    plt.plot(epochs_to_plot, invex_ones_grad_norm_theta, 'rx', ls=(0, (1, 1)))  # x + dotted
    ...
    plt.plot(epochs_to_plot, invex_ones_grad_norm_p, 'gx', ls=(0, (1, 1)))  # x + dotted
    ...
    plt.savefig(PLOTS_RESULTS_FOLDER +
                f'{model}/Gradient Norm/{experiment_name}_theta_p.pdf', format='pdf', dpi=1200)

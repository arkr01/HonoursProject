...
if __name__ == '__main__':
    ...
    experiment = Workflow(cifar10_training_data, cifar10_test_data, grad_norm_tol=-1, num_epochs=200,
                          compare_dropout=True, compare_batch_norm=True, dropout_val=0.5)
    print(experiment.lr)
